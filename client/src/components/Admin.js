...
function ActivityTab() {
  ...
  useEffect(() => {
    Axios.get("https://api.we0mmm.site/api/getactivity0/", {
      withCredentials: true,
    })
      .then((resp) => {
        setUsers(resp.data);
    ...
    Axios.get("https://api.we0mmm.site/api/getuser/", { withCredentials: true })
      .then((resp) => {
...
function StatementTab() {
  ...
  useEffect(() => {
    Axios.get("https://api.we0mmm.site/api/getstatement/", {
      withCredentials: true,
    })
      .then((resp) => {
...
function updateUserData(e) {
  ...
  Axios.post("https://api.we0mmm.site/api/updateuser/", data, {
    withCredentials: true,
  })
    .then((resp) => {
...
function deleteUserData(e) {
  ...
  Axios.post("https://api.we0mmm.site/api/deleteuser/" + data, {
    withCredentials: true,
  })
    .then((resp) => {
      console.log("Deleted!");
